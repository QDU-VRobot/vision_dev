...
struct RuneDetectorParam
{
  ...
  YML_INIT(RuneDetectorParam, YML_ADD_PARAM(GRAY_THRESHOLD_RED);
           YML_ADD_PARAM(GRAY_THRESHOLD_BLUE); YML_ADD_PARAM(MIN_CONTOUR_AREA);
           YML_ADD_PARAM(MAX_CONTOUR_AREA); YML_ADD_PARAM(BIG_ACTIVE_FAN_AREA);
           YML_ADD_PARAM(ACTIVE_FAN_CONCENTRICITY_RATIO);
           YML_ADD_PARAM(MIN_FORCE_CONSTRUCT_ANGLE);
           YML_ADD_PARAM(INACTIVE_TARGET_ACCURACY); YML_ADD_PARAM(ACTIVE_TARGET_ACCURACY);
           YML_ADD_PARAM(INACTIVE_FAN_ACCURACY); YML_ADD_PARAM(MIN_INACTIVE_FAN_ACCURACY);
           YML_ADD_PARAM(ACTIVE_FAN_ACCURACY); YML_ADD_PARAM(MIN_CENTER_ACCURACY);
           YML_ADD_PARAM(MAX_DISTANCE_RATIO); YML_ADD_PARAM(MAX_MATCH_DEVIATION_RATIO);
