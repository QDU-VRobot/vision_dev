...
struct RuneCenterParam
{
  ...
  YML_INIT(RuneCenterParam, YML_ADD_PARAM(MAX_AREA); YML_ADD_PARAM(MIN_AREA);
           YML_ADD_PARAM(MAX_SIDE_RATIO); YML_ADD_PARAM(MIN_SIDE_RATIO);
           YML_ADD_PARAM(MAX_SUB_AREA_RATIO); YML_ADD_PARAM(MIN_CONVEX_AREA_RATIO);
           YML_ADD_PARAM(MIN_ROUNDNESS); YML_ADD_PARAM(MIN_AREA_FOR_RATIO);
           YML_ADD_PARAM(DEFAULT_SIDE); YML_ADD_PARAM(CENTER_CONCENTRICITY_RATIO);
           YML_ADD_PARAM(TRANSLATION); YML_ADD_PARAM(ROTATION););
};
