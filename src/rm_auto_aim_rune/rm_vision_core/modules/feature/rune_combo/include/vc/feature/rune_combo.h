...
class RuneCombo : public FeatureNode
{
 ...
 public:
   ...
   */
  RuneCombo(const FeatureNode_ptr& p_target, const FeatureNode_ptr& p_center,
   ...
   */
  static Ptr make_feature(const PoseNode& pnp_data, const RuneType& type,
  ...
  static inline const std::shared_ptr<const RuneCombo> cast(FeatureNode_cptr p_combo)
  {
    return std::dynamic_pointer_cast<const RuneCombo>(p_combo);
  }
