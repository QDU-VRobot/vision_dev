...
struct RuneTargetParam
{
  ...
  YML_INIT(RuneTargetParam, YML_ADD_PARAM(RADIUS); YML_ADD_PARAM(ACTIVE_MIN_AREA);
           YML_ADD_PARAM(ACTIVE_MAX_AREA); YML_ADD_PARAM(ACTIVE_MIN_SIDE_RATIO);
           YML_ADD_PARAM(ACTIVE_MAX_SIDE_RATIO); YML_ADD_PARAM(ACTIVE_MIN_AREA_RATIO);
           YML_ADD_PARAM(ACTIVE_MAX_AREA_RATIO); YML_ADD_PARAM(ACTIVE_MIN_PERI_RATIO);
           ...
           YML_ADD_PARAM(ACTIVE_DEFAULT_SIDE); YML_ADD_PARAM(ACTIVE_3D);
           YML_ADD_PARAM(INACTIVE_MIN_AREA); YML_ADD_PARAM(INACTIVE_MAX_AREA);
           YML_ADD_PARAM(INACTIVE_MIN_SIDE_RATIO); YML_ADD_PARAM(INACTIVE_MAX_SIDE_RATIO);
           YML_ADD_PARAM(INACTIVE_MIN_AREA_RATIO); YML_ADD_PARAM(INACTIVE_MAX_AREA_RATIO);
           YML_ADD_PARAM(INACTIVE_MIN_PERI_RATIO); YML_ADD_PARAM(INACTIVE_MAX_PERI_RATIO);
           YML_ADD_PARAM(INACTIVE_3D); YML_ADD_PARAM(GAP_MIN_AREA_RATIO);
           YML_ADD_PARAM(GAP_MAX_AREA_RATIO); YML_ADD_PARAM(GAP_MIN_SIDE_RATIO);
           YML_ADD_PARAM(GAP_MAX_SIDE_RATIO); YML_ADD_PARAM(GAP_CIRCLE_RADIUS_RATIO);
           YML_ADD_PARAM(GAP_MAX_DISTANCE_RATIO); YML_ADD_PARAM(GAP_MIN_DISTANCE_RATIO);
           YML_ADD_PARAM(GAP_3D); YML_ADD_PARAM(ROTATION); YML_ADD_PARAM(TRANSLATION););
};
...
struct RuneTargetDrawParam
{
  ...
  struct Active
  {
    ...
    YML_INIT(Active, YML_ADD_PARAM(color); YML_ADD_PARAM(thickness);
             YML_ADD_PARAM(point_radius); YML_ADD_PARAM(default_circle_radius););
  } active;
  ...
  struct Inactive
  {
    ...
    YML_INIT(Inactive, YML_ADD_PARAM(color); YML_ADD_PARAM(thickness);
             YML_ADD_PARAM(point_radius); YML_ADD_PARAM(default_circle_radius);
             YML_ADD_PARAM(font_scale); YML_ADD_PARAM(font_thickness);
