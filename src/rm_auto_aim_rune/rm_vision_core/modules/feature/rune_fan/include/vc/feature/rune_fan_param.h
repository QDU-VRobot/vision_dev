...
struct RuneFanParam
{
  ...
  YML_INIT(RuneFanParam, YML_ADD_PARAM(ACTIVE_MAX_SIDE_RATIO);
           YML_ADD_PARAM(ACTIVE_MIN_AREA); YML_ADD_PARAM(ACTIVE_MAX_AREA);
           YML_ADD_PARAM(ACTIVE_MIN_AREA_RATIO); YML_ADD_PARAM(ACTIVE_MAX_AREA_RATIO);
           YML_ADD_PARAM(ACTIVE_MAX_AREA_PERIMETER_RATIO);
           YML_ADD_PARAM(ACTIVE_MIN_AREA_PERIMETER_RATIO); YML_ADD_PARAM(ACTIVE_TOP_3D);
           YML_ADD_PARAM(ACTIVE_BOTTOM_CENTER_3D); YML_ADD_PARAM(ACTIVE_SIDE_3D);
           YML_ADD_PARAM(ACTIVE_BOTTOM_SIDE_3D); YML_ADD_PARAM(ACTIVE_TRANSLATION);
           YML_ADD_PARAM(ACTIVE_ROTATION); YML_ADD_PARAM(ACTIVE_MIN_AREA_INCOMPLETE);
           ...
           YML_ADD_PARAM(INACTIVE_MAX_SIDE_RATIO); YML_ADD_PARAM(INACTIVE_MIN_SIDE_RATIO);
           YML_ADD_PARAM(INACTIVE_MIN_AREA); YML_ADD_PARAM(INACTIVE_MAX_AREA);
           YML_ADD_PARAM(INACTIVE_MAX_DISTANCE_RATIO); YML_ADD_PARAM(INACTIVE_3D);
           YML_ADD_PARAM(INACTIVE_TRANSLATION); YML_ADD_PARAM(INACTIVE_ROTATION););
};
...
struct RuneFanDrawParam
{
  ...
  struct Active
  {
    ...
    YML_INIT(Active, YML_ADD_PARAM(color); YML_ADD_PARAM(thickness);
             YML_ADD_PARAM(point_radius); YML_ADD_PARAM(font_scale);
             YML_ADD_PARAM(font_thickness); YML_ADD_PARAM(font_color);
             YML_ADD_PARAM(arrow_thickness); YML_ADD_PARAM(arrow_length);
