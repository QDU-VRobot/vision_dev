...
class RuneFanActive : public RuneFan
{
  ...
  DEFINE_PROPERTY(TopHumpCorners, protected, protected,
                  (std::vector<cv::Point2f>));  //!< 扇叶顶部突起角点
  DEFINE_PROPERTY(BottomCenterHumpCorners, protected, protected,
                  (std::vector<cv::Point2f>));  //!< 扇叶底部中心突起角点
  DEFINE_PROPERTY(SideHumpCorners, protected, protected,
                  (std::vector<cv::Point2f>));  //!< 扇叶侧面突起角点
  DEFINE_PROPERTY(BottomSideHumpCorners, protected, protected,
                  (std::vector<cv::Point2f>));  //!< 扇叶底部侧面突起角点
 ...
 public:
   ...
   */
  RuneFanActive(const Contour_cptr& contour, const cv::RotatedRect& rotated_rect,
