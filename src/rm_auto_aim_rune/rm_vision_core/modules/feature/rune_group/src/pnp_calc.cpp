...
bool RuneGroup::correctRoll(const PoseNode& raw_cam_pnp_data,
                            PoseNode& corrected_cam_pnp_data)
{
  ...
  auto [yaw_raw, pitch_raw, roll_raw] =
      data_converters["1"]->rvec2Euler(raw_cam_pnp_data.rvec());
