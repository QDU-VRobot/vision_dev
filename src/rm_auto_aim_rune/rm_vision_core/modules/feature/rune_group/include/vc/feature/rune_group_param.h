...
struct RuneGroupParam
{
  ...
  YML_INIT(RuneGroupParam, YML_ADD_PARAM(INTERVAL_ANGLE); YML_ADD_PARAM(RAW_DATAS_SIZE);
           YML_ADD_PARAM(MAX_VANISH_NUMBER); YML_ADD_PARAM(MAX_YAW_DEVIATION);
           YML_ADD_PARAM(MAX_PITCH_DEVIATION); YML_ADD_PARAM(MAX_ROLL_DEVIATION);
           YML_ADD_PARAM(MAX_X_DEVIATION); YML_ADD_PARAM(MAX_Y_DEVIATION);
           YML_ADD_PARAM(MAX_Z_DEVIATION); YML_ADD_PARAM(MAX_GET_PENDING_DATA_LENGTH);
           YML_ADD_PARAM(ENABLE_EXTREME_VALUE_FILTER); YML_ADD_PARAM(MAX_DISTANCE);
           YML_ADD_PARAM(MIN_DISTANCE); YML_ADD_PARAM(MAX_ROTATE_YAW);
           YML_ADD_PARAM(MAX_ROTATE_PITCH); YML_ADD_PARAM(MAX_YAW_DEVIATION_ANGLE);
