...
class RuneFilterEKF_CV : public RuneFilterStrategy
{
 public:
  ...
  /**
   * @brief Predict pose ahead by dt_future (seconds) WITHOUT modifying internal state.
   * @param dt_future seconds
   * @return predicted pose [x y z | yaw pitch roll]
   */
  cv::Matx61d predictAhead(double dt_future) const;
